            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form" method="post" action="{{route('category.add')}}" id="add_category" name="add_category">
                            @csrf
                            <div class="form-group m-t-40 row">
                                <label for="name" class="col-2 col-form-label">Category Name</label>
                                <div class="col-10">
                                    <input class="form-control" type="text" name="name" id="name" placeholder="Please Enter Category Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="text-center">
                                    <input type="submit" name="submit" class="btn btn-primary" value="Insert Category">
                                </div>
                            </div>
