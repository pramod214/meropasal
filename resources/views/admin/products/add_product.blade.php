            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form" method="post" action="{{route('product.add')}}" id="add_product" name="add_product"enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="product_name" id="name" placeholder="Please Enter Product Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="product_code" id="code" placeholder="Please Enter Product Code">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="product_color" id="color" placeholder="Please Enter Product Color">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="price" id="price" placeholder="Please Enter Price Of Products">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <textarea name="description" id="description" cols="30" rows="10" class="form-control col-12"></textarea>
                                </div>
                            </div>
