    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Add a New Coupons</h4>
                        ...
                        @endif
                        <form class="form" method="post" action="" id="add_coupon" name="add_product" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="coupon_code" id="coupon_code" placeholder="Please Enter coupon_code">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="amount" id="amount" placeholder="Please Enter Amount">
                                </div>
                            </div>
